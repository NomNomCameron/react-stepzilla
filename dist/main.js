...
var StepZilla = function (_Component) {
  ...
  _createClass(StepZilla, [{
    ...
    value: function jumpToStep(evt) {
      ...
      var _value = evt.target.value || parseInt(evt.target.getAttribute("value"));
      if (evt.target == undefined) {
        ...
        if (!this.props.stepsNavigation || _value === this.state.compState) {
        ...
        var movingBack = _value < this.state.compState; // are we trying to move back or front?
        ...
        this.abstractStepMoveAllowedToPromise(movingBack).then(function () {
          ...
          if (proceed) {
            if (!movingBack) {
              ...
              passThroughStepsNotValid = _this3.props.steps.reduce(function (a, c, i) {
                if (i >= _this3.state.compState && i < _value) {
                  a.push(c.validated);
                }
                return a;
              }, []).some(function (c) {
          ...
          if (proceed && !passThroughStepsNotValid) {
            if (_value === _this3.props.steps.length - 1 && _this3.state.compState === _this3.props.steps.length - 1) {
              _this3.setNavState(_this3.props.steps.length);
            } else {
              _this3.setNavState(_value);
            }
          }
        }).catch(function (e) {
          if (e) {
    ...
    value: function stepMoveAllowed() {
      ...
      if (this.props.dontValidate) {
        ...
        if (skipValidationExecution) {
          ...
          var component = this.refs.activeComponent || this.activeComponent;
      ...
      return this.props.steps.map(function (s, i) {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            'em',
            null,
            _react2.default.createElement('i', { value: i, onClick: function onClick(evt) {
                _this5.jumpToStep(evt);
              }, className: 'fa ' + (_this5.props.stepIcons[i] || "fa-info-circle") })
          ),
          _react2.default.createElement(
            'span',
            null,
    ...
    value: function render() {
      ...
      var cloneExtensions = {
        ...
        ref: function ref(el) {
          return _this6.activeComponent = el;
        }
      };
